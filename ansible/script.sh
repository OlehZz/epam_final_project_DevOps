...
sed -i 's/spring.datasource.url=jdbc:mysql:\/\/localhost/spring.datasource.url=jdbc:mysql:\/\/terraform-20210310112809528000000001.cnowmm0u4gtt.us-east-1.rds.amazonaws.com/g' /home/ubuntu/jenkins/workspace/'setup jenkins node'/footgo/src/main/resources/application.properties